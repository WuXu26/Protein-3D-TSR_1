...
class Dendograming:
	...
	def get_all_figures(self,type):
		...
		#changed here Sarika
		pd.DataFrame(list(df.index[[ax_clustermap.dendrogram_row.reordered_ind]])).to_csv(os.path.join(self.folder,"clustermap_reordered_names_{}.csv".format(type)))
