        ...
        if not args.skip:
			...
			#print('allD: ', allDistances)
                        if maxDist < int(args.size_gap): 
                            ...
                            orig_aacd0 = aminoacidCount[indexOf0]
                            orig_aacd1 = aminoacidCount[indexOf1]
                            orig_aacd2 = aminoacidCount[indexOf2]
                            ...
                            if key_2 in filesDict:
                                ...
                                filesDict[key_2] = 1
                            line = (str(key_2) +"\t" + str(orig_aacd0) + "\t" + str(position0) + "\t" + \
                                str(orig_aacd1) + "\t" + str(position1) + "\t" + str(orig_aacd2) + "\t" + \
...
if __name__ == '__main__':
    ...
    fileType = "*.pdb"
    aminoAcidCode=open(os.path.join(args.path, "aminoAcidCode_grouping2.txt"),"r") 
    aminoAcidLabel={}
