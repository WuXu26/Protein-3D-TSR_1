...
if __name__ == '__main__':
    ...
    aminoAcidCode.close()
    outFolder = os.path.join(args.path, args.sample_name,"theta"+str(dTheta)+"_dist"+str(dLen),"Inter")
    ...
    df2.to_csv(os.path.join(args.path,args.sample_name,'sample_details_inter.csv'))
